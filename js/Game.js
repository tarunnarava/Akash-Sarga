class Game {
  ...
  start() {
    ...
    this.addSpirtes(fuels, 4, fuelImage, 0.5);

    // Adding coin sprite in the game
    this.addSpirtes(powerCoins, 18, powerCoinImage,0.1);

    //C41 //BP //SA
    var obstaclesPositions = [
      { x: width / 2 + 250, y: height - 800, image: obstacle3Image },
      { x: width / 2 - 150, y: height - 1300, image: obstacle1Image },
      { x: width / 2 + 250, y: height - 1800, image: obstacle3Image },
      { x: width / 2 - 180, y: height - 2300, image: obstacle4Image },
      { x: width / 2, y: height - 2800, image: obstacle3Image },
      { x: width / 2 - 180, y: height - 3300, image: obstacle1Image },
      { x: width / 2 + 180, y: height - 3300, image: obstacle2Image },
      { x: width / 2 + 250, y: height - 3800, image: obstacle4Image },
      { x: width / 2 - 150, y: height - 4300, image: obstacle1Image },
      { x: width / 2 + 250, y: height - 4800, image: obstacle2Image },
      { x: width / 2, y: height - 5300, image: obstacle4Image },
